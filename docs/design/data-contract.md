...
**Status:** accepted (Phase 1). The schema lives at
`seo_geo_engine/crawler/site-dict.schema.json` and is checked against
Layer 1 fixtures, the sample crawl, and the Layer 2 live crawl.
...
Until that file exists, this document is the contract. The schema file
now exists at `seo_geo_engine/crawler/site-dict.schema.json`; this
document remains the narrative contract.
